...
class DartDeclaration {
  ...
  String toConstructor() {
    ...
    String suffix = '';
    String coreType = (type??'').split('<').first;
    print(type);
    if(!isNullable){
      switch (coreType) {
        case 'String': suffix = ' = ""'; break;
        case 'int': suffix = ' = 0'; break;
        case 'double': suffix = ' = 0.0'; break;
        case 'bool': suffix = ' = false'; break;
        case 'List': suffix = ' = const []'; break;
        case 'Map': suffix = ' = const {}'; break;
        case 'dynamic': break;
        default: isNullable = true;
      }
    }

    return '$nullable this.$name$suffix,'.trim().indented();
  }
